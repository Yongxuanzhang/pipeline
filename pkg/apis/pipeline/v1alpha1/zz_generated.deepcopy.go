...
func (in *VerificationPolicySpec) DeepCopyInto(out *VerificationPolicySpec) {
	*out = *in
	if in.ResourcesPolicyMapping != nil {
		in, out := &in.ResourcesPolicyMapping, &out.ResourcesPolicyMapping
		*out = make(map[ResourcePattern][]Authority, len(*in))
		for key, val := range *in {
			var outVal []Authority
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
