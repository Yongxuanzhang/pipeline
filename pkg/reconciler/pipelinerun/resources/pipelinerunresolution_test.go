...
func nopGetTask(context.Context, string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
...
func TestResolvePipelineRun_PipelineTaskHasNoResources(t *testing.T) {
	...
	getTask := func(ctx context.Context, name string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
...
func TestResolvePipeline_WhenExpressions(t *testing.T) {
	...
	getTask := func(_ context.Context, name string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
		return task, nil, nil, nil
	}
	pr := v1.PipelineRun{
		ObjectMeta: metav1.ObjectMeta{
...
func TestResolvePipelineRunTask_WithMatrix(t *testing.T) {
	...
	rtr := &resources.ResolvedTask{
		TaskName: "task",
		TaskSpec: &pipeline.TaskSpec{Steps: []pipeline.Step{{
			Name: "step1",
		}}},
	}
