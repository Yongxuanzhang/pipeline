...
func GetTaskFuncFromTaskRun(ctx context.Context, k8s kubernetes.Interface, tekton clientset.Interface, requester remoteresource.Requester, taskrun *v1.TaskRun, verificationPolicies []*v1alpha1.VerificationPolicy) GetTask {
	...
	if taskrun.Status.TaskSpec != nil {
		return func(_ context.Context, name string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
			...
			internalspec:= pipeline.TaskSpec{}
			err:=v1.Convert_v1_TaskSpec_To_pipeline_TaskSpec(taskrun.Status.TaskSpec, &internalspec,nil)
			if err!=nil{
...
func GetTaskFunc(ctx context.Context, k8s kubernetes.Interface, tekton clientset.Interface, requester remoteresource.Requester,
	...
	case tr != nil && tr.Resolver != "" && requester != nil:
		...
		return func(ctx context.Context, name string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
...
func resolveTask(ctx context.Context, resolver remote.Resolver, name string, kind v1.TaskKind, k8s kubernetes.Interface, verificationPolicies []*v1alpha1.VerificationPolicy) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
...
func readRuntimeObjectAsTask(ctx context.Context, obj runtime.Object, k8s kubernetes.Interface, refSource *v1.RefSource, verificationPolicies []*v1alpha1.VerificationPolicy) (*pipeline.Task, *trustedresources.VerificationResult, error) {
	t := &v1.Task{
	...
	err=v1.Convert_v1_Task_To_pipeline_Task(t, internalTask, nil)
	if err!=nil{
		return nil,nil,err
	}
...
func (l *LocalTaskRefResolver) GetTask(ctx context.Context, name string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
	if l.Kind == v1.ClusterTaskRefKind {
		...
		err=v1.Convert_v1_Task_To_pipeline_Task(v1task, internalTask, nil)
		if err!=nil{
			return nil,nil,nil,err
		}
