...
// VerificationResult is the result from trusted resources if the feature is enabled.
type GetTask func(context.Context, string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error)
...
func GetTaskData(ctx context.Context, taskRun *v1.TaskRun, getTask GetTask) (*resolutionutil.ResolvedObjectMeta, *pipeline.TaskSpec, error) {
	...
	case taskRun.Spec.TaskSpec != nil:
		...
		v1.Convert_v1_TaskSpec_To_pipeline_TaskSpec(taskRun.Spec.TaskSpec, &taskSpec, nil)
