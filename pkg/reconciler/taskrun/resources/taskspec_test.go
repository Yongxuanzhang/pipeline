...
func TestGetTaskSpec_Ref(t *testing.T) {
	...
	gt := func(ctx context.Context, n string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
...
func TestGetTaskData_ResolutionSuccess(t *testing.T) {
	...
	getTask := func(ctx context.Context, n string) (*pipeline.Task, *v1.RefSource, *trustedresources.VerificationResult, error) {
