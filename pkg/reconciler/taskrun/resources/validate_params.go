...
func ValidateParamArrayIndex(ts *pipeline.TaskSpec, params v1.Params) error {
...
func ValidateOutOfBoundArrayParams(declarations pipeline.ParamSpecs, params v1.Params, arrayIndexingReferences sets.String) error {
